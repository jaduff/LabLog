...
namespace LabLog.WriteTests.EntityTests
{
    public class VersionTests
    {
        ...
        public async Task VersionIncrementsOnce()
        {
            await CTest<WriteSchoolContext>
                .Given(a => a.School())
                .And(a => a.RoomAddedEvent(new Guid("11111111-1111-1111-1111-111111111111"), "test room"))
                .When(i => i.AddAComputer(new Guid("11111111-1111-1111-1111-111111111111"), "serial", "Computer One", 1))

    ...
    public class EventReplayTests
    {
        ...
        public async Task NewSchoolReplaysComputerAdded()
        {
            await CTest<WriteSchoolContext>
                ...
                .And(a => a.ComputerAddedEvent(new Guid("11111111-1111-1111-1111-111111111111"), "serial", "Computer Six", 6))
                ...
                .Then(c =>
                {
                    ...
                    Assert.Equal(1, c.Context.School.Rooms[0].Computers.Count);
                    Assert.Equal(6, c.Context.School.Rooms[0].Computers[0].Position);
                    Assert.Equal("Computer Six", c.Context.School.Rooms[0].Computers[0].ComputerName);
                })
                .ExecuteAsync();
        }
